...
OUT_DIR = Path("./embeddings_uncleaned")
...
model.save("./model/word2vec_uncleaned.model")
...
out_dir = Path.cwd() / "embeddings_uncleaned"
out_dir.mkdir(parents=True, exist_ok=True)

out_path = out_dir / "word2vec_base_uncased_word_embeddings_uncleaned.pkl"
